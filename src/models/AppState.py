...
from src.data.FileGetStockInfos import FileGetStockInfos
...
class AppState:
    ...
    def __init__(self):
        ...
        # NEU: Service für alle aktienbezogenen Anfragen
        self.stock_data_manager: FileGetStockInfos = FileGetStockInfos()
