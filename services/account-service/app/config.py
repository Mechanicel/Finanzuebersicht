...
class Settings(ServiceSettings):
    ...
    account_repository_backend: str = Field(default="mongo", alias="ACCOUNT_REPOSITORY_BACKEND")
    ...
    mongo_accounts_collection: str = Field(default="accounts", alias="MONGO_ACCOUNTS_COLLECTION")
